...
d3.json("../json/foodgrain.json", function(error, data) {
    ...
    data.forEach(function(d) {
        ...
        d["Foodgrain crop type"] = d["Foodgrain crop type"];
    ...
    svg.selectAll('rect')
        ...
        .attr({
            "x": function(d) {
                return xScale(d["Foodgrain crop type"]); },
            "y": function(d) {
    ...
    svg.selectAll('text')
        ...
        .text(function(d) {
            return d.Production; })
        .attr('x', function(d) {
            return xScale(d["Foodgrain crop type"]) + xScale.rangeBand() / 2; })
        .attr('y', function(d) {
